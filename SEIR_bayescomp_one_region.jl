...
initial_sample = sample(model_window_fixed, my_gibbs, MCMCThreads(), n_samples, n_chains; num_warmup = n_warmup_samples, discard_initial = 0, progress = true, model_check = false)
