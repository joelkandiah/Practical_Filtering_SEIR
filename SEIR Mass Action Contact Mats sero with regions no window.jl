...
outdir = string("Results/10bp pop_reg/$Δ_βt","_beta/no_window/chains_$n_chains/n_threads_$n_threads/Plot attempt $seed_idx/")
tmpstore = string("Chains/10bp pop_reg/$Δ_βt","_beta/no_window/chains_$n_chains/n_threads_$n_threads/Plot attempt $seed_idx/")
